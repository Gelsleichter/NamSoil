...
png(paste0("../../output/plots/exploratory_spatial_distrib_soil_prop_top_bottom_depth/Subsurface_Soil_prop_", paste(i, collapse = "_"), "_num_pnts_", nrow(md), ".png"), 
...
write_xlsx(
  md,
  path = paste0("../../output/datasets/exploratory_spatial_distrib_soil_prop_top_bottom_depth/Subsurface_Soil_prop_", paste(i, collapse = "_"), "_num_pnts_", nrow(md), ".xlsx"),
  col_names = TRUE,
  format_headers = TRUE#,
  # use_zip64 = FALSE
)
...
# Export as .shp / .gpkg
writeVector(sampl_point, paste0("../../output/shapes/Subsurface_Soil_prop_", paste(i, collapse = "_"), "_num_pnts_", nrow(md), ".shp"), overwrite= TRUE)
